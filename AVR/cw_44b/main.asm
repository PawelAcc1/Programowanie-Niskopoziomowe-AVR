///PROGRAM COUNTS 0-9999 DISPLAYING CURRENT NUMBER ON 7 SEG DISPLAY\\\
...
.def DecIncrementAux1=R6 ;VALUE OF INCREMENTATION (1)
.def DecIncrementAux2=R7 ;=0 FOR SELF ADDITION
...
LDI R20, 1
MOV DecIncrementAux1, R20 
LDI R20, 0
MOV DecIncrementAux2, R20
...
main:
    ...
    /*MOD 1000 COUNTER*/
    ADD PulseEdgeCtrL, DecIncrementAux1
    ADC PulseEdgeCtrH, DecIncrementAux2
